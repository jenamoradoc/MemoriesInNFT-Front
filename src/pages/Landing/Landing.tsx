      ...
      <div className='xl:flex justify-between flex-row-reverse xl:flex-row'>
        <div className='lg:max-w-[35%] lg:px-16'>
            <div className='py-10'>
                ...
                En definitiva, "Malvinas en NFT" busca convertirse en un punto de encuentro para todos aquellos que quieran conocer y preservar la historia de nuestro país, y especialmente para aquellos que sienten un profundo respeto y agradecimiento por quienes defendieron nuestra patria en momentos tan difíciles.</p>
            </div>
            <div className='flex justify-around'>
                <Link to="/home"><button className='border border-black py-1 px-3 hover:border-blue-400 hover:text-blue-400'>Crea tu NFT</button></Link>
                <Link to="/about"><button className='border-b-2 border-black py-1 px-3 hover:border-blue-400 hover:text-blue-400'>Lee sobre nosotros</button></Link>
            </div>
        </div>
